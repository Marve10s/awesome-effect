...
- [Applications and examples](applications.md) - Open source apps built on Effect, plus templates and starters.
- [Learning Effect](learning.md) - Courses, patterns, articles, talks, and podcasts.
- [Community and adoption](community.md) - Meetups, official channels, and companies using Effect.
...
- [kitlangton/skills](https://github.com/kitlangton/skills) - Kit Langton's local Effect skill. Pairs with Effect Solutions in [learning.md](learning.md#courses-and-guides).
